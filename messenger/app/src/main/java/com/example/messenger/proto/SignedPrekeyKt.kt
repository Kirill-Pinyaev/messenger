...
public inline fun signedPrekey(block: com.example.messenger.proto.SignedPrekeyKt.Dsl.() -> kotlin.Unit): com.example.messenger.proto.SignedPrekey =
  com.example.messenger.proto.SignedPrekeyKt.Dsl._create(com.example.messenger.proto.SignedPrekey.newBuilder()).apply { block() }._build()
/**
...
public object SignedPrekeyKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.example.messenger.proto.SignedPrekey.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.example.messenger.proto.SignedPrekey.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.example.messenger.proto.SignedPrekey = _builder.build()
...
public inline fun com.example.messenger.proto.SignedPrekey.copy(block: `com.example.messenger.proto`.SignedPrekeyKt.Dsl.() -> kotlin.Unit): com.example.messenger.proto.SignedPrekey =
  `com.example.messenger.proto`.SignedPrekeyKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.example.messenger.proto.SignedPrekeyOrBuilder.publishedAtOrNull: com.google.protobuf.Timestamp?
